	...
	'aI': {
		...
		'1385583': {
			...
			'citingPapersList': [
				...
				125, 126, 127, 128, 129, 130, 131, 132, 133, 134, 135, 135]]},
		'1404176': {
			'date': datetime.datetime(2015, 11, 13, 4, 51, 44),
			'infoDict': {
				1408518: {'date': datetime.datetime(2015, 12, 8, 4, 58, 55)}},
			'citingPapersList': [
				[datetime.datetime(2015, 11, 13, 4, 51, 44),
				datetime.datetime(2015, 12, 8, 4, 58, 55),
				datetime.date(2018, 7, 13)],
		...
		'1387736': {
			...
			'infoDict': {
				...
				1499583: {'date':
					datetime.datetime(2016, 11, 22, 20, 51, 29)}},
			'citingPapersList': [[datetime.datetime(2015, 8, 14, 4, 34, 30),
				datetime.datetime(2015, 12, 16, 4, 35, 24),
				datetime.datetime(2016, 2, 4, 4, 43, 41),
				datetime.datetime(2016, 5, 19, 6, 9, 9),
				datetime.datetime(2016, 6, 13, 16, 50, 42),
		...
		'1519902': {
			...
			'infoDict': {},
			'citingPapersList': [[datetime.datetime(2017, 3, 29, 11, 29, 12),
				datetime.date(2018, 7, 13)],
				[1, 1]]}
		},
	'h': 4,
	'paLi': [[datetime.datetime(2013, 4, 22, 4, 52, 23),
		datetime.datetime(2015, 2, 23, 4, 40, 55),
		datetime.datetime(2015, 5, 6, 4, 44, 44),
		datetime.datetime(2015, 7, 30, 4, 49, 20),
		...
		[1, 2, 3, 4, 5, 6, 7, 8]],
	'meanLi': [[datetime.datetime(2015, 2, 3, 4, 55, 48),
		datetime.datetime(2015, 2, 23, 4, 40, 55),
		datetime.datetime(2015, 4, 29, 4, 46, 57),
		datetime.datetime(2015, 7, 2, 4, 44, 49),
		datetime.datetime(2015, 7, 22, 5, 19, 4),
		...
		datetime.datetime(2018, 6, 29, 4, 38, 51),
		datetime.datetime(2018, 6, 29, 4, 38, 51)],
		[1.0, 1.0, 1.5, 1.3333333333333333, 1.6666666666666667, 1.5, 1.75,
		2.0, 2.25, 2.5, 2.2, 2.4, 2.6, 2.8, 2.5, 2.6666666666666665,
		2.8333333333333335, 3.0, 3.1666666666666665, 3.3333333333333335, 3.5,
		3.6666666666666665, 3.8333333333333335, 4.0, 4.166666666666667,
		4.333333333333333, 4.5, 4.666666666666667, 4.833333333333333, 5.0,
		5.166666666666667, 5.333333333333333, 5.5, 5.666666666666667,
		5.833333333333333, 6.0, 6.166666666666667, 6.333333333333333, 6.5,
		6.666666666666667, 6.833333333333333, 7.0, 7.166666666666667,
		7.333333333333333, 6.428571428571429, 6.571428571428571,
		6.714285714285714, 6.857142857142857, 7.0, 7.142857142857143,
		7.285714285714286, 7.428571428571429, 7.571428571428571,
		7.714285714285714, 7.857142857142857, 8.0, 8.142857142857142,
		8.285714285714286, 8.428571428571429, 8.571428571428571,
		8.714285714285714, 8.857142857142858, 9.0, 9.142857142857142,
		9.285714285714286, 9.428571428571429, 9.571428571428571,
		9.714285714285714, 9.857142857142858, 10.0, 10.142857142857142,
		10.285714285714286, 10.428571428571429, 10.571428571428571,
		10.714285714285714, 10.857142857142858, 11.0, 11.142857142857142,
		11.285714285714286, 11.428571428571429, 11.571428571428571,
		11.714285714285714, 11.857142857142858, 12.0, 12.142857142857142,
		12.285714285714286, 12.428571428571429, 12.571428571428571,
		12.714285714285714, 12.857142857142858, 13.0, 13.142857142857142,
		13.285714285714286, 13.428571428571429, 13.571428571428571,
		13.714285714285714, 13.857142857142858, 14.0, 14.142857142857142,
		14.285714285714286, 14.428571428571429, 14.571428571428571,
		14.714285714285714, 14.857142857142858, 13.125, 13.25, 13.375, 13.5,
		13.625, 13.75, 13.875, 14.0, 14.125, 14.25, 14.375, 14.5, 14.625,
		14.75, 14.875, 15.0, 15.125, 15.25, 15.375, 15.5, 15.625, 15.75,
		15.875, 16.0, 16.125, 16.25, 16.375, 16.5, 16.625, 16.75, 16.875,
		17.0, 17.125, 17.25, 17.375, 17.5, 17.625, 17.75, 17.875, 18.0,
		18.125, 18.25, 18.375, 18.5, 18.625, 18.75, 18.875, 19.0, 19.125,
		19.25, 19.375, 19.5, 19.625, 19.75, 19.875, 20.0, 20.125, 20.25,
		20.375, 20.5, 20.625, 20.75, 20.875, 21.0, 21.125, 21.25, 21.375,
...
class TestAuthorStatsPlots(GUIwMainWTestCase):
	...
	def test_init(self):
		...
		with patch("physbiblio.gui.inspireStatsGUI.AuthorStatsPlots."
			...
			self.assertEqual(asp.layout().itemAtPosition(5, 0).widget(),
				asp.textBox)
		...
		for i in [0, 1, 2]:
			for j in [0, 1]:
				self.assertIsInstance(
					asp.layout().itemAtPosition(i, j).widget(),
					FigureCanvasQTAgg)
				self.assertEqual(
...
class TestPaperStatsPlots(GUIwMainWTestCase):
	...
	def test_init(self):
		...
		self.assertIsInstance(asp.textBox, QLineEdit)
		self.assertTrue(asp.textBox.isReadOnly())
		self.assertEqual(asp.layout().itemAtPosition(3, 0).widget(),
			asp.textBox)
		self.assertIsInstance(asp.saveButton, QPushButton)
		self.assertEqual(asp.saveButton.text(), "Save")
