...
class TestDialogWindows(GUITestCase):
    ...
    def test_askYesNo(self):
        ...
        with patch("physbiblio.gui.basicDialogs.QMessageBox", return_value=mb) as _mb:
    ...
    def test_askGenericText(self):
        ...
        q = QWidget()
        qid = MagicMock()
        qid.exec.side_effect = [True, False, True]
        qid.textValue.side_effect = ["abc", "def", "ghi"]
        with patch(
            "physbiblio.gui.basicDialogs.QInputDialog", return_value=qid
        ) as _qid:
            ...
            qid.exec.assert_called_once_with()
    ...
    def test_askFileName(self):
        ...
        with patch("physbiblio.gui.basicDialogs.QFileDialog", return_value=fd) as _fd:
            ...
            fd.exec.assert_called_once_with()
    ...
    def test_askFileNames(self):
        """Test askFileNames"""
        fd = MagicMock()
        fd.exec.side_effect = [False, True]
