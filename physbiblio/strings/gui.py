...
class BibWindowsStrings(CommonStrings, CommonGUIStrings):
    ...
    class Acts(CommonStrings):
        ...
        adsCompl = "Complete info (ID and auxiliary info)"
        adsLoad = "Load abstract"
        adsMerge = "Merge bibtex from ADS-NASA"
        adsMore = "Get more fields"
        adsTit = "ADS-NASA"
        arxDowD = (
        ...
        arxMerge = "Merge bibtex from arXiv"
        ...
        doiMerge = "Merge bibtex from DOI"
        doiTit = "DOI"
        eDesc = "--Entry: %s--"
        ...
        insMerge = "Merge bibtex from INSPIRE-HEP"
