...
class TestParser(unittest.TestCase):
	...
	def test_subcommands_ok(self):
		...
		tests = [
			...
			["tex", "physbiblio.export.pbExport.exportForTexFile", ["f1", "f2"], ([["f2"], "f1"], {"autosave": True, "overwrite": False})],
			["tex", "physbiblio.export.pbExport.exportForTexFile", ["f1", "f2", "-o"], ([["f2"], "f1"], {"autosave": True, "overwrite": True})],
			["tex", "physbiblio.export.pbExport.exportForTexFile", ["f1", "f2", "--overwrite"], ([["f2"], "f1"], {"autosave": True, "overwrite": True})],
			["tex", "physbiblio.export.pbExport.exportForTexFile", ["f1", "f2", "--ov"], ([["f2"], "f1"], {"autosave": True, "overwrite": True})],
			["tex", "physbiblio.export.pbExport.exportForTexFile", ["f1", "f2", "-s"], ([["f2"], "f1"], {"autosave": False, "overwrite": False})],
			["tex", "physbiblio.export.pbExport.exportForTexFile", ["f1", "f2", "--save"], ([["f2"], "f1"], {"autosave": False, "overwrite": False})],
			["tex", "physbiblio.export.pbExport.exportForTexFile", ["f1", "f2", "--sa"], ([["f2"], "f1"], {"autosave": False, "overwrite": False})],
			["tex", "physbiblio.export.pbExport.exportForTexFile", ["f1", "f2", "f3", "--sa"], ([["f2", "f3"], "f1"], {"autosave": False, "overwrite": False})],
